...
local subMenu = RageUI.CreateSubMenu(mainMenu, "Banque", "Menu")
local subMenu2 = RageUI.CreateSubMenu(mainMenu, "Bijouterie", "Menu")
        ...
        Citizen.CreateThread(function()
            while openedMenu do 
                RageUI.IsVisible(mainMenu, function()
                    RageUI.Button("~p~Banque", nil, {RightLabel = "→→"}, true, {}, subMenu)
                    RageUI.Button("~b~Bijouterie", nil, {RightLabel = "→→"}, true, {}, subMenu2)
                end)
                RageUI.IsVisible(subMenu, function()
                    if #Config.Item.Banque ~= 0 then 
                        RageUI.Separator("↓ Liste des object volés à la banque ↓")
                ...
                RageUI.IsVisible(subMenu2, function()
                    if #Config.Item.Bijouterie ~= 0 then 
                        RageUI.Separator("↓ Liste des object volés à la bijouterie ↓")
